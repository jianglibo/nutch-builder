 ...
 */
@Component
public class NutchBuilderTemplateFacadeRepositoryImpl extends FacadeRepositoryBaseImpl<NutchBuilderTemplate> implements NutchBuilderTemplateFacadeRepository {
