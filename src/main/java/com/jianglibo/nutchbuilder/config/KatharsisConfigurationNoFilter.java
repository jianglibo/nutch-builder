...
public class KatharsisConfigurationNoFilter {
	...
	@Bean
	public KatharsisProcessor katharsisProcessor(KatharsisBoot boot) {
		...
		return new KatharsisProcessor(objectMapper, resourceRegistry, requestDispatcher, properties.getPathPrefix());
	}
